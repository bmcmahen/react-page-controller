...
export const IconWeather: React.FunctionComponent<IconProps> = ({
  color = "currentColor",
  size = 24,
  ...other
}) => {
  return (
    <svg width="60px" height="78px" viewBox="0 0 60 78" version="1.1">
      <title>Weather</title>
      ...
      <defs>
        <linearGradient
          ...
          id="linearGradient-1"
        >
          <stop stop-color="#1D62F0" offset="0%" />
          <stop stop-color="#19D5FD" offset="100%" />
        </linearGradient>
      </defs>
      <g
        id="Page-1"
        ...
        fill-rule="evenodd"
      >
        <g id="Home" transform="translate(-202.000000, -116.000000)">
          <g id="Weather" transform="translate(202.000000, 116.000000)">
            <text
              font-family="Helvetica"
              font-size="13"
              font-weight="normal"
              line-spacing="16"
              letter-spacing="-0.0799999982"
              fill="#FFFFFF"
            >
              <tspan x="6" y="77">
                Weather
